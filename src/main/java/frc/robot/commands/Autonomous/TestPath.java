...
public class TestPath extends SequentialCommandGroup {
  ...
  ShooterSubsystem shooterSubsystem, LimelightSubsystem limelightSubsystem, ArmSubsystem armSubsystem) {
    super (
      ...
      new ParallelCommandGroup(
        new AutoMoveDistance(driveSubsystem, -1.5), 
      ...
      new AutoReverseShoot(shooterSubsystem).withTimeout(0.17), //0.13
      
      new StopNWait(driveSubsystem, 0.15), 

      new ParallelCommandGroup(
        new AutoTurn(driveSubsystem, 9).withTimeout(1.5),
        //new AlignShooter(limelightSubsystem, driveSubsystem).withTimeout(1),
      ...
      new ParallelCommandGroup(
        new AutoMoveDistance(driveSubsystem, -4), //-4.8
